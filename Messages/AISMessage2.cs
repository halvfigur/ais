...
{
    public sealed class AISMessage2 : AISMessage
    {
        ...
        public AISMessage2(AISSentenceParser SentenceParser) :
            base("Position Resport Class A (Assigned schedule)", SentenceParser, AISMessageType.Message2)
        {
            int longitude;
            int latitude;
