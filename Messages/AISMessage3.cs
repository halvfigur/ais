...
{
    public sealed class AISMessage3 : AISMessage
    {
        ...
        public AISMessage3(AISSentenceParser SentenceParser) :
            base("Position Report Class A (Response to interrogation)", SentenceParser, AISMessageType.Message3)
        {
            int longitude;
            int latitude;
