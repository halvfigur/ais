...
{
    public sealed class AISMessage11 : AISMessage
    {
        ...
        public AISMessage11(AISSentenceParser SentenceParser) :
            base("UTC and Date Response", SentenceParser, AISMessageType.Message10)
        {
