...
{
    public sealed class AISMessage7 : AISMessage
    {
        ...
        public AISMessage7(AISSentenceParser SentenceParser) :
            base("Binary Acknowledge", SentenceParser, AISMessageType.Message7)
        {
